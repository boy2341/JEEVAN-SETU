...
1. **Emergency Routing System** – Identifies and prioritises the nearest and most capable hospital.
...
2. The input is processed through a Semi-LLM pipeline to:
   ...
   - Determine required specialisation
...
In emergency scenarios, decision speed is more important than deep analysis. The system prioritises:
...
3. The system categorises the urgency level.
4. The nearest suitable hospital is instantly recommended.
